...
if __name__ == '__main__':
    ...
    parser.add_argument("--model_path", default="saved_language_model/bm25_Plus_04_06_model_full_manual_stopword", type=str)
    ...
    with open("saved_language_model/doc_refers_saved", "rb") as doc_refer_file:
